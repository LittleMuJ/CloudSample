...
import com.sample.applicationadmin.validator.group.AddGroup;
import com.sample.applicationadmin.validator.group.UpdateGroup;
...
public class SysUserController extends BaseController {
    ...
    public R update(@RequestBody SysUserEntity user) {
        validateEntity(user, UpdateGroup.class);

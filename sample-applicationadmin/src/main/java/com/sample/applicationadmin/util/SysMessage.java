...
public class SysMessage {
	...
	public static final String VERIFICATION_CODE_SUCCESS = "验证码正确";
	
	public static final String SIGNUP_SUCCESS = "注册成功";
	public static final String SIGNUP_ERRROR = "注册失败";
	
	public static final String AUTHENTICATION_ERRROR = "身份验证失败";
	
	public static final String GET_ERRROR = "获取失败";
